...
--tags[s] = awful.tag({"SCREEN-"..s}, s, awful.layout.suit.max.fullscreen)
tags = {}
for s = 1, screen.count() do
    if s == primary_screen then
        tags[s] = awful.tag(tagnames, s, awful.layout.suit.max)
    else
        tags[s] = awful.tag(tagnames2, s, awful.layout.suit.floating)
    end
end
-- }}}
